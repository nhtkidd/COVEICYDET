...
<div id="father" class="flex items-center justify-center h-auto">
    <div class="wrapper bg-white w-full md:w-[90%] h-auto] mt-10 ">
        ...
        <section id="bienvenida" class="w-full h-[60vh] md:h-[35%] lg:h-[70%]  p-[5%] text-center  ">
            <h1 class="text-xl lg:text-4xl font-bold">Propuestas sin Sede</h1>
            <form>
                @csrf
            ...
            <div class="flex flex-warp">
                ...
                <a class="px-5 font-bold text-lg text-gray-600 underline" href="{{route('proveicydet.admin.proposalNS')}}" title="Propuestas sin sede">Sin sede</a>
