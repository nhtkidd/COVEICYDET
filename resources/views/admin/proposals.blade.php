        ...
        <section id="bienvenida" class="w-full h-[60vh] md:h-[35%] lg:h-[70%]  p-[5%] text-center  ">
            ...
            <form>
                ...
                <div class="flex flex-wrap w-50 flex-row-reverse p-4">
                    ...
                    <div class="buscador-texto w-50 p-2">
                        <input type="text" name="sectors" id="buscar" class="w-25 inputsStyle focus:outline-none focus:shadow-outline" placeholder="Buscar" value="{{$buscarpor}}">
                    </div>
                    <div class="w-25 p-2">
