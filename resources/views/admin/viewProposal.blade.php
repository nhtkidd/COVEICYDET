                ...
                <div class="p-[5%] mt-5 lg:mt-0">
                    ...
                    <div class="my-3">
                        ...
                        <form action="{{route('proveicydet.admin.proposal-update',$data->idProposal)}}" method="post" class=" p-[5%] mt-5 lg:mt-0  " name="form1">
                            @csrf
                            @method('PUT')
                            <div class="w-50 pt-4 flex flex-wrap justify-center align-items-center">
                                <div class="w-50 p-4">
                                    <input type="submit" name="status" value="Aceptar" class="text-white bg-[#109618] hover:bg-[#635C44]/90 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 mr-2">
                                </div>
                                <div class="w-50 p-4">
                                    <input type="submit" name="status" value="Rechazar" class="text-white bg-[#DC3912] hover:bg-[#635C44]/90 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 mr-2">
                                </div>
                            </div>
                        </form>
                        @endif
