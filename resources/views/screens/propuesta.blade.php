...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-1" type="radio" value="1" name="fk_idAnnexe"
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-2" type="radio" value="2" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-5" type="radio" value="5" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-6" type="radio" value="6" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-7" type="radio" value="7" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-8" type="radio" value="8" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-11" type="radio" value="11" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-13" type="radio" value="13" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-14" type="radio" value="14" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-15" type="radio" value="15" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-17" type="radio" value="17" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-18" type="radio" value="18" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-23" type="radio" value="23" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-24" type="radio" value="24" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-25" type="radio" value="25" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-3" type="radio" value="3" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-4" type="radio" value="4" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-9" type="radio" value="9" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-10" type="radio" value="10" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-12" type="radio" value="12" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-16" type="radio" value="16" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-19" type="radio" value="19" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-22" type="radio" value="22" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-20" type="radio" value="20" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
...
<div class="md:w-full flex flex-wrap items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
    <input id="bordered-radio-21" type="radio" value="21" name="fk_idAnnexe"
    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    <label for="bordered-radio-1"
    class="py-4 ml-2 w-[90%] text-sm font-medium text-gray-700 dark:text-gray-700">
